# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'views/expired_medicine_report_views.xml',
        'views/expired_medicine_report_pdf.xml',
    ],
    'assets': {
        'web.assets_backend': [
            'tasneem_module/static/src/css/expired_location.css',
            'tasneem_module/static/src/css/expired_medicine_report.css',
            'tasneem_module/static/src/js/expired_medicine_report.js',
            'tasneem_module/static/src/xml/expired_medicine_report.xml',
        ],
    },
    'installable': True,
    'application': False,
